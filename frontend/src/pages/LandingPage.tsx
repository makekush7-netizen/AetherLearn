...
// Demo lecture slides - Full 10-slide Photosynthesis lecture
const demoSlides = [
  "/slides/photosynthesis/slide1.svg",
  "/slides/photosynthesis/slide2.svg",
  "/slides/photosynthesis/slide3.svg",
  "/slides/photosynthesis/slide4.svg",
  "/slides/photosynthesis/slide5.svg",
  "/slides/photosynthesis/slide6.svg",
  "/slides/photosynthesis/slide7.svg",
  "/slides/photosynthesis/slide8.svg",
  "/slides/photosynthesis/slide9.svg",
  "/slides/photosynthesis/slide10.svg",
];

// Audio files generated by KokoroTTS - matches slides
const demoAudioFiles = [
  "/audio/photosynthesis/slide1.wav",
  "/audio/photosynthesis/slide2.wav",
  "/audio/photosynthesis/slide3.wav",
  "/audio/photosynthesis/slide4.wav",
  "/audio/photosynthesis/slide5.wav",
  "/audio/photosynthesis/slide6.wav",
  "/audio/photosynthesis/slide7.wav",
  "/audio/photosynthesis/slide8.wav",
  "/audio/photosynthesis/slide9.wav",
  "/audio/photosynthesis/slide10.wav",
];
...
const LandingPage = () => {
  ...
  // Callback when slide audio finishes - advance to next slide
  const handleSlideComplete = useCallback(() => {
    setCurrentSlide(prev => {
      const nextSlide = prev + 1;
      // If we've completed all slides, stop playing
      if (nextSlide >= demoSlides.length) {
  ...
  // Reset to first slide when play starts from beginning
  useEffect(() => {
    if (isDemoPlaying && currentSlide === 0) {
      // Starting fresh playback
      console.log("Starting demo playback from slide 1");
    }
  }, [isDemoPlaying, currentSlide]);
                    ...
                    <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          className="bg-white/70 hover:bg-white text-primary shadow-lg disabled:opacity-30 disabled:cursor-not-allowed h-8 w-8 p-0"
                        >
